...
const AlibabaLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M4.08 11.92s1.42.06 1.74.06c.32 0 .42-.08.42-.32 0-.24-.04-.54-.04-.54.02-.32-.2-.58-.58-.58-.38 0-1.54.02-1.54.02s-.14-.46-.14-.72c0-.26.26-.34.26-.34s.8.02 1.4.02c.6 0 .96-.34.96-.94 0-.6-.04-1.66-.04-1.66l-2.68 1s-.14-.38-.14-.66c0-.28.1-.56.1-.56s.22-.06.74-.22c.52-.16 2.38-.72 2.38-.72s.22.68.22 1.18c0 .5-.16.92-.16.92s1.18-.32 1.84-.46c.66-.14 1-.46 1-.98 0-.52-.18-1.52-.18-1.52s.7.02 1.08.02c.38 0 .54-.22.54-.54 0-.32-.02-.8-.02-.8s-.68.04-1.18.04c-.5 0-.94-.2-.94-.8 0-.6.18-1.92.18-1.92h1.66s.38.38.64.64c.26.26.4.52.4.52s-.04.6-.04 1.1c0 .5.3.82.8.82.5 0 2.22-.02 2.22-.02s.18 1 .18 1.52c0 .52-.3 1.02-.92 1.28-.62.26-1.56.64-1.56.64s.22.42.22.92c0 .5-.16 1.5-.16 1.5s1.28-.1 1.94-.18c.66-.08 1.08.06 1.08.56 0 .5-.12 1.34-.12 1.34s-.4.04-1.16.08c-.76.04-1.18.22-1.18.72 0 .5.08 1.14.08 1.14s.78-.02 1.38-.02c.6 0 .9.38.9.98 0 .6-.1 1.62-.1 1.62s-.42-.04-1.32-.04c-.9 0-1.5.26-1.5.86 0 .6.14 1.76.14 1.76s.48.02 1.14.02c.66 0 1.02.3 1.02.8s-.1 1.28-.1 1.28-1.14.34-1.94.52c-.8.18-1.2.6-1.2 1.2 0 .6.14 1.82.14 1.82h-1.66s-.02-1.34-.02-1.84c0-.5-.4-1-.9-1-.5 0-2.38.02-2.38.02s-.3 1.34-.3 1.84c0 .5-.4.92-.9.92-.5 0-1.52-.08-1.52-.08s-.18-1.2-.18-1.7c0-.5.2-1 .7-1.2.5-.2 1.46-.54 1.46-.54s-.12-.46-.12-.86c0-.4.1-.72.1-.72s-1.04.04-1.74.04c-.7 0-1.16-.3-1.16-.8 0-.5.1-1.34.1-1.34s.34.02.84.02c.5 0 .84-.22.84-.72 0-.5-.12-1.12-.12-1.12s-1.18.06-1.88.06c-.7 0-1.18-.32-1.18-.82 0-.5.12-1.42.12-1.42s.38.06.94.06c.56 0 .9-.22.9-.62 0-.4-.14-.94-.14-.94s-1.1.06-1.82.06c-.72 0-1.12-.34-1.12-.84 0-.5.12-1.44.12-1.44zm3.94-.4s.22-.04.42-.04c.2 0 .28.14.28.34 0 .2-.06.4-.06.4s-.32.02-.54.02c-.22 0-.32-.1-.32-.32 0-.22.22-.4.22-.4zm-.12 3.06s.28-.02.5-.02c.22 0 .3.1.3.3s-.08.4-.08.4s-.34.02-.58.02c-.24 0-.34-.14-.34-.34 0-.2.2-.36.2-.36zm-.12 3.02s.3-.02.58-.02c.28 0 .38.1.38.3s-.1.44-.1.44s-.42.06-.68.06c-.26 0-.38-.1-.38-.3s.2-.48.2-.48zm.28 3.02s.34-.02.66-.02c.32 0 .42.14.42.34 0 .2-.1.46-.1.46s-.5.06-.82.06c-.32 0-.42-.16-.42-.36 0-.2.26-.48.26-.48z" />
  </svg>
);
...
const GroqLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
const MODELS = [
  ...
  { id: "meta-llama/llama-4-scout-17b-16e-instruct", label: "Llama 4 Scout", badge: "Pro", icon: <MetaLogo className="w-3.5 h-3.5" /> },
  { id: "qwen/qwen3-32b", label: "Qwen 3 32B", badge: "Smart", icon: <AlibabaLogo className="w-3.5 h-3.5" /> },
  { id: "moonshotai/kimi-k2-instruct", label: "Kimi K2", badge: "Experimental", icon: <MoonshotLogo className="w-3.5 h-3.5" /> },
  { id: "groq/compound", label: "Groq Compound", badge: "New", icon: <GroqLogo className="w-3.5 h-3.5" /> },
];
